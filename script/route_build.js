    ...
    return app.config(['$stateProvider','$urlRouterProvider','$locationProvider',function($stateProvider,$urlRouterProvider,$locationProvider) {
        ...
        $stateProvider
            ...
            .state('app.user',{
                url:'user',
                templateUrl: function($routeParams){
                    return 'view/setting/user_list.html';
                },
            ...
            .state('app.goods_declare_list',{
                ...
                templateUrl:'view/goods_declare/goods_declare_list.html',
            ...
            .state('app.exception_order_list', {
                ...
                templateUrl: function(){
                    return 'view/exception_order/exception_order_list.html';
                },
            ...
            .state('app.goods_declare_detail',{
                ...
                templateUrl: function($routeParams){
                    return 'view/goods_declare/goods_declare_detail_'+$routeParams.customs+'.html';
                },
            ...
            .state('app.goods_declare_edit',{
                ...
                templateUrl: function($routeParams){
                    return 'view/goods_declare/goods_declare_edit_'+$routeParams.customs+'.html';
                },
            ...
            .state('app.goods_record',{
                ...
                templateUrl: 'view/goods_record/goods_record_list.html',
            ...
            .state('app.goods_record_create',{
                ...
                templateUrl: function($routeParams){
                    return 'view/goods_record/goods_record_detail_'+$routeParams.customs+'.html';
                },
            ...
            .state('app.goods_record_import',{
                ...
                templateUrl: function($routeParams){
                    return 'view/goods_record/goods_record_import.html';
                },
            ...
            .state('app.role',{
                url:'setting/role/:id',
                templateUrl: function($routeParams){
                    return 'view/setting/role_detail.html';
                },
            ...
            .state('app.warehouse',{
                url:'base/warehouse',
                templateUrl: function($routeParams){
                    return 'view/base/warehouse_list.html';
                },
            ...
            .state('app.warehouse_detail',{
                ...
                templateUrl: function($routeParams){
                    return 'view/base/warehouse_detail.html';
                },
            ...
            .state('app.customer_list',{
                url:'base/customer',
                templateUrl: function($routeParams){
                    return 'view/base/customer_list.html';
                },
            ...
            .state('app.customer_create',{
                ...
                templateUrl: function($routeParams){
                    return 'view/base/customer_detail.html';
                },
            ...
            .state('app.interface_list',{
                url:'base/interface',
                templateUrl: function($routeParams){
                    return 'view/base/interface_list.html';
                },
            ...
            .state('app.interface_create',{
                ...
                templateUrl: function($routeParams){
                    return 'view/base/interface_detail.html';
                },
            ...
            .state('app.external_list',{
                url:'base/external',
                templateUrl: function($routeParams){
                    return 'view/base/external_list.html';
                },
            ...
            .state('app.external_create',{
                ...
                templateUrl: function($routeParams){
                    return 'view/base/external_detail.html';
                },
            ...
            .state('app.section_number',{
                ...
                templateUrl: function($routeParams){
                    return 'view/number_manage/section_number.html';
                },
            ...
            .state('app.logistic_setting_list',{
                ...
                templateUrl: function($routeParams){
                    return 'view/number_manage/logistic_setting_list.html';
                },
            ...
            .state('app.logistic_setting_detail',{
                ...
                templateUrl: function($routeParams){
                    return 'view/number_manage/logistic_setting_detail.html';
                },
            ...
            .state('app.warehouse_logistic_list',{
                ...
                templateUrl: function($routeParams){
                    return 'view/number_manage/warehouse_logistic_list.html';
                },
            ...
            .state('app.warehouse_logistic_detail',{
                ...
                templateUrl: function($routeParams){
                    return 'view/number_manage/warehouse_logistic_detail.html';
                },
            ...
            .state('app.notification_message_list',{
                ...
                templateUrl: function($routeParams){
                    return 'view/system_monitor/notification_message.html';
                },
            ...
            .state('app.abroad_check_order_list', {
                ...
                templateUrl: function(){
                    return 'view/rule_manage/abroad_checkorder_list.html';
                },
            ...
            .state('app.abroad_check_order_create', {
                ...
                templateUrl: function($routeParams){
                    return 'view/rule_manage/abroad_checkorder_detail.html';
                },
